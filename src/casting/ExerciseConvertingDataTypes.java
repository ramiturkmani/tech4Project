...
public class ExerciseConvertingDataTypes {
    public static void main(String[] args){
        ...
        int num1Avg = Integer.valueOf(num1); // String --> Integer --> int
        int num2Avg = Integer.parseInt(num2); // String --> int

        Integer num1Integer = Integer.valueOf(num1); // String --> Integer
        Integer num2Integer = Integer.parseInt(num2); // String --> int --> Integer

        System.out.println("Average with int is = "+((num1Avg+num2Avg)/2));
        System.out.println("Average with Integer is = "+((num1Integer+num2Integer)/2));
        ...
        System.out.println("Number of days to save up for a bike = "+ (int)(saveDouble/dayDouble));
